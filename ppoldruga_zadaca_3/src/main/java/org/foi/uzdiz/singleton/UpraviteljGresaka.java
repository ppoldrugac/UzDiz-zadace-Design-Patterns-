...
public class UpraviteljGresaka {
	...
	public void greskaURetku(String zapis, String opisGreske) {
		...
		if (!zabiljezeneGreske.contains(kljucGreske)) {
			...
			System.out.println("Ukupno grešaka: " + brojacGresaka + " || Br. greške unutar datoteke: "
	...
	public void greskaSDatotekama(String opisGreske) {
		brojacGresaka++;
		System.out.println("Ukupno grešaka: " + brojacGresaka + " || Opis greške s datotekom: " + opisGreske + "\n");
	}

	public void sustavskaGreska(Exception e) {
		brojacGresaka++;
		System.out
				.println("Ukupno grešaka: " + brojacGresaka + " || Opis sustavske greške: " + e.getMessage() + "\n");
	}

	public void greskaURadu(String opisGreske) {
		brojacGresaka++;
		System.out.println("Ukupno grešaka: " + brojacGresaka + " || Opis greške u radu: " + opisGreske + "\n");
	}

	public void greskaUlazneKomande(String opisGreske) {
		brojacGresaka++;
		System.out.println(
				"Ukupno grešaka: " + brojacGresaka + " || Opis greške u ulaznoj komandi: " + opisGreske + "\n");
	}
