...
public class SustavFacade {
    ...
    public void inicijalizirajProdajaKarataOriginator() {
    	Tvrtka.getInstance().dohvatiProdajaKarataOriginator();
    	System.out.println("Sustav za prodaju karata je spreman.");
    }
    ...
    public void inicijalizirajLanacKomandi() {
        ...
        LanacKomandi komandaSVV = new KomandaSVV();
        LanacKomandi komandaCVP = new KomandaCVP();
        LanacKomandi komandaKKPV2S = new KomandaKKPV2S();
        LanacKomandi komandaIKKPV = new KomandaIKKPV();
        ...
        komandaNO.postaviSljedeceg(komandaSVV);
        komandaSVV.postaviSljedeceg(komandaCVP);
        komandaCVP.postaviSljedeceg(komandaKKPV2S);
        komandaKKPV2S.postaviSljedeceg(komandaIKKPV);
